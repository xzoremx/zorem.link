 ...
 * Matches the design from the original index.html
 */
...
export function LandingPage() {
    ...
    const handleJoinRoom = async (e?: FormEvent) => {
        ...
        try {
            ...
            if (result.valid) {
                navigate(`/nickname?code=${roomCode}`);
            } else {
    ...
    return (
        <div className="min-h-screen bg-[#050505] antialiased selection:bg-white/20 selection:text-white overflow-x-hidden text-neutral-300">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 border-b bg-[#050505]/80 backdrop-blur-xl transition-all duration-300 border-white/5">
                <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
                    <div className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity">
                        <img src="/logo.png" alt="Zorem" className="w-8 h-8 object-contain logo-spin" />
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-8 text-[13px] font-medium text-neutral-400">
                        ...
                        <div className="flex items-center gap-3 ml-2 pl-4 border-l border-white/10">
                            <a href="#" className="flex items-center gap-1.5 transition-colors hover:text-white" title="Download on App Store">
                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
                            </a>
                            <a href="#" className="flex items-center gap-1.5 transition-colors hover:text-white" title="Get it on Google Play">
                    ...
                    <div className="flex items-center gap-3">
                        {isAuthenticated ? (
                            ...
                            <>
                                <Link to="/auth" className="text-[13px] font-medium transition-colors px-2 hidden sm:block text-neutral-400 hover:text-white">
                                    Sign in
                                </Link>
                                <Link to="/auth?mode=signup" className="text-[13px] font-medium transition-colors px-2 hidden sm:block text-neutral-400 hover:text-white">
                                    Register
                                </Link>
                            </>
                        )}
            ...
            <main className="flex flex-col text-center max-w-[90rem] z-10 mr-auto ml-auto pt-24 pr-4 pb-20 pl-4 relative items-center">
                ...
                <div className="w-full max-w-4xl mx-auto overflow-hidden opacity-40 hover:opacity-80 transition-opacity duration-500">
                    <div className="flex items-center justify-center gap-8 md:gap-16 flex-wrap">
                        ...
                        <div className="flex items-center gap-2 text-neutral-600">
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
            ...
            <section id="features" className="py-20 px-6 max-w-7xl mx-auto relative">
                ...
                <div className="mb-16 flex flex-col md:flex-row items-start justify-between gap-8">
                    ...
                    <div className="hidden md:block text-right">
                        <div className="text-xs font-mono text-neutral-500 mb-1">PRIVACY FIRST</div>
                        <div className="flex items-center justify-end gap-2 text-violet-500 text-xs font-medium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-[minmax(300px,auto)]">
                    ...
                    {/* Card 1: Ephemeral Stories */}
                    <div
                        ref={(el) => { cardRefs.current[0] = el; }}
                        className="md:col-span-3 lg:col-span-4 glass rounded-3xl p-8 relative overflow-hidden group card-shine flex flex-col justify-between"
                    >
                        <div className="relative z-10">
                            ...
                            <p className="text-sm leading-relaxed text-neutral-400">Stories auto-destruct after the time you set. No screenshots notifications, no permanence. Share freely.</p>
                        </div>
                        
                        <div className="absolute right-4 bottom-4 flex gap-1 opacity-40 group-hover:opacity-100 transition-opacity">
                            <div className="h-8 px-3 flex items-center justify-center rounded border border-violet-500/20 text-[10px] font-mono bg-violet-900/30 text-violet-400">24H MAX</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        className="md:col-span-3 lg:col-span-8 glass rounded-3xl p-0 relative overflow-hidden group card-shine"
                    >
                        <div className="absolute inset-0 bg-grid opacity-20" />
                        
                        <div className="absolute inset-0 flex items-center justify-center z-0">
                            {/* Code Visual */}
                            <div className="relative w-full h-full opacity-50 group-hover:opacity-100 transition-opacity duration-700 flex items-center justify-center">
                                <div className="flex gap-3">
                                    <div className="w-14 h-20 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center text-3xl font-mono text-white">Z</div>
                                    <div className="w-14 h-20 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center text-3xl font-mono text-white">6</div>
                                    <div className="w-14 h-20 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center text-3xl font-mono text-white">R</div>
                                    <div className="w-14 h-20 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center text-3xl font-mono text-white">7</div>
                                    <div className="w-14 h-20 rounded-lg border border-white/10 bg-white/5 flex items-center justify-center text-3xl font-mono text-white">M</div>
                                    <div className="w-14 h-20 rounded-lg border border-violet-500/30 bg-violet-500/10 flex items-center justify-center text-3xl font-mono text-violet-400 animate-pulse">_</div>
                                </div>
                            </div>
                        </div>

                        <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-[#050505] to-transparent z-10">
                            <h3 className="text-xl font-medium mb-2 text-white">Access by Code</h3>
                            <p className="text-sm max-w-md text-neutral-400">Like Kahoot, but for stories. Share a 6-digit code and your audience is in. No accounts, no friction.</p>
                        </div>
                    </div>

                    {/* Card 3: No Social Features */}
                    <div
                        ref={(el) => { cardRefs.current[2] = el; }}
                        className="md:col-span-6 lg:col-span-6 glass rounded-3xl p-8 relative overflow-hidden group card-shine flex flex-col justify-between h-[320px]"
                    >
                        <div className="relative z-20">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <div className="flex items-center gap-2 text-neutral-500">
                                    <span className="text-xs line-through">Followers</span>
                                    <span className="text-xs line-through">Feed</span>
                                    <span className="text-xs line-through">Algorithm</span>
                                </div>
                            </div>
                            <h3 className="text-xl font-medium mb-2 text-white">Not a Social Network</h3>
                            <p className="text-sm text-neutral-400">No followers to manage. No feed to scroll. No algorithm deciding who sees what. Just you, your story, and the people you invite.</p>
                        </div>
                        
                        <div className="absolute right-0 bottom-0 w-48 h-48 bg-gradient-to-tl from-violet-500/10 to-transparent rounded-tl-full" />
                    </div>

                    {/* Card 4: Rooms */}
                    <div
                        ref={(el) => { cardRefs.current[3] = el; }}
                        className="md:col-span-6 lg:col-span-6 glass rounded-3xl relative overflow-hidden group card-shine h-[320px]"
                    >
                        <div className="absolute top-0 left-0 w-full h-8 border-b flex items-center px-4 gap-2 bg-white/5 border-white/5">
                            ...
                            <div className="w-2.5 h-2.5 rounded-full bg-violet-500/20 border border-violet-500/50" />
                            <div className="w-2.5 h-2.5 rounded-full bg-violet-500/20 border border-violet-500/50" />
                            <span className="ml-2 text-[10px] font-mono text-neutral-500">room.config</span>
                        </div>
                        <div className="p-8 mt-8 font-mono text-xs leading-relaxed text-neutral-400">
                            <p><span className="text-violet-400">const</span> <span className="text-blue-400">room</span> = {'{'}</p>
                            <p className="pl-4">code: <span className="text-violet-400">'XJ420M'</span>,</p>
                            <p className="pl-4">expires: <span className="text-violet-400">'24h'</span>,</p>
                            <p className="pl-4">viewers: <span className="text-blue-400">27</span>,</p>
                            <p className="pl-4">stories: [</p>
                            <p className="pl-8">{'{'} type: <span className="text-violet-400">'image'</span>, seen: <span className="text-blue-400">true</span> {'}'},</p>
                            <p className="pl-8">{'{'} type: <span className="text-violet-400">'video'</span>, seen: <span className="text-blue-400">false</span> {'}'}</p>
                            <p className="pl-4">]</p>
                            <p>{'}'}</p>
                        </div>
                        <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-[#0A0A0B] via-[#0A0A0B]/90 to-transparent">
                            <h3 className="text-lg font-medium text-white">Rooms that Expire</h3>
                            <p className="text-sm text-neutral-500">Create a room, set the timer, share the code. When time's up, it's gone.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="how-it-works" className="py-32 relative overflow-hidden border-t border-white/5">
                <div className="absolute inset-0 bg-gradient-to-b from-[#050505] via-violet-950/5 to-[#050505]" />
                <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
                    ...
                    <div className="w-full max-w-4xl mt-16">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-neutral-500">Upload your stories and set how long they'll last. Get a unique 6-digit code.</p>
                            </div>
                            <div className="text-center">
                                <div className="w-16 h-16 rounded-2xl border border-white/10 bg-white/5 flex items-center justify-center mx-auto mb-6">
                                ...
                                <p className="text-sm text-neutral-500">Send the code to whoever you want. They enter it here and they're in.</p>
                            </div>
                            <div className="text-center">
                                <div className="w-16 h-16 rounded-2xl border border-white/10 bg-white/5 flex items-center justify-center mx-auto mb-6">
                                ...
                                <p className="text-sm text-neutral-500">When time expires, the room and all its stories disappear forever. No trace.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mt-20 text-center">
                        <div>
                            <div className="text-3xl font-serif italic mb-1 text-white">&lt;3s</div>
                            <div className="text-xs text-neutral-500 uppercase tracking-widest">To join a room</div>
                        </div>
                        <div>
                            <div className="text-3xl font-serif italic mb-1 text-white">0</div>
                            <div className="text-xs text-neutral-500 uppercase tracking-widest">Data stored</div>
                        </div>
                        <div>
                            <div className="text-3xl font-serif italic mb-1 text-white">100%</div>
                            <div className="text-xs text-neutral-500 uppercase tracking-widest">Private</div>
                        </div>
                        <div>
                            <div className="text-3xl font-serif italic mb-1 text-white">24h</div>
                            <div className="text-xs text-neutral-500 uppercase tracking-widest">Max lifetime</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="privacy" className="sm:py-24 py-16 pb-16 max-w-5xl mx-auto px-6 border-t border-white/5">
                <div className="mb-12">
                    <div className="text-center mb-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left items-center">
                            ...
                            <div className="lg:col-span-7">
                                <h3 className="text-[32px] sm:text-[48px] lg:text-[64px] xl:text-[80px] leading-[0.9] uppercase font-semibold tracking-tight text-white">
                                    For Every<br />Moment.
                                </h3>
                            </div>
                            ...
                            <div className="lg:col-span-5">
                                <p className="sm:text-lg text-neutral-400 max-w-3xl mt-0 mr-auto mb-6 ml-0">
                                    From intimate gatherings to exclusive events. Zorem adapts to how you want to share—privately and temporarily.
                                </p>
                                <div className="flex justify-start">
                                    <button
                                        onClick={handleCreateRoom}
                                        className="inline-flex items-center gap-3 ring-1 ring-white/10 hover:shadow-2xl hover:bg-white/10 transition bg-white/5 rounded-full pt-2 pr-2 pb-2 pl-2 shadow"
                                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 rounded-2xl overflow-hidden shadow-sm ring-1 ring-white/10">
                    {/* Left Use Case */}
                    <div className="relative overflow-hidden text-neutral-300 bg-[#0A0A0B] pt-6 pr-6 pb-6 pl-6">
                    ...
                    <div className="lg:col-span-3 border-t border-white/10">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-0">
                            <div className="text-white bg-[#0A0A0B] border-white/10 border-r pt-6 pr-6 pb-6 pl-6">
            ...
            <footer className="relative pt-32 pb-12 bg-[#050505] overflow-hidden">
                {/* Background Glow */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[400px] bg-[radial-gradient(circle_at_bottom,_var(--tw-gradient-stops))] from-violet-900/20 via-transparent to-transparent pointer-events-none" />
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col items-center text-center mb-24">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <button
                                onClick={() => (document.querySelector('.code-input') as HTMLInputElement)?.focus()}
                                className="h-12 px-8 rounded-full border font-medium text-sm transition-all border-white/10 text-neutral-400 hover:text-white hover:bg-white/5"
                            >
                                Join with code
                            </button>
                        </div>
                        <div className="mt-6 flex flex-col gap-1 text-[11px] text-neutral-600">
                            ...
                            <span>Free to create. Premium features available.</span>
                        </div>
                    </div>

                    <div className="border-t pt-12 flex flex-col md:flex-row justify-between gap-8 border-white/5">
                        <div className="flex items-center gap-2">
                            <img src="/logo.png" alt="Zorem" className="w-5 h-5 object-contain opacity-60" />
