...
export const storage = {
    ...
    setAuthToken: (token: string): void => localStorage.setItem('auth_token', token),
    clearAuthToken: (): void => {
        localStorage.removeItem('auth_token');
        localStorage.removeItem('auth_email');
    },

    getAuthEmail: (): string | null => localStorage.getItem('auth_email'),
    setAuthEmail: (email: string): void => localStorage.setItem('auth_email', email),

    getViewerHash: (): string | null => localStorage.getItem('viewer_hash'),
    setViewerHash: (hash: string): void => localStorage.setItem('viewer_hash', hash),

    getRoomId: (): string | null => localStorage.getItem('current_room_id'),
    setRoomId: (id: string): void => localStorage.setItem('current_room_id', id),
